...
export const copy = {
  tr: {
    ...
    androidTest: {
      ...
      pageDescription: 'Vaktio+ Android closed test grubuna katılma ve test adımları.',
      back: 'Ana sayfa',
      ...
      intro: 'Teste katılmak için aşağıdaki adımları takip et.',
      joinHeading: 'Gruba katıl',
      joinDescription: 'Önce test grubuna erişim isteği gönder.',
      groupCta: 'Test grubuna katıl',
      groupUrl: 'https://groups.google.com/u/2/g/vaktio-testers',
      stepsHeading: 'Test adımları',
      steps: [
        'Aşağıdaki opt-in linkine gir',
        'Become a tester butonuna bas',
        'Play Store üzerinden uygulamayı indirip kullan',
      ],
      linksHeading: 'Test linkleri',
      links: [
        {
          label: 'Android',
  ...
  en: {
    ...
    androidTest: {
      pageTitle: 'Android Closed Test · Vaktio+',
      pageDescription: 'How to join the Vaktio+ Android closed test group and start testing.',
      back: 'Home',
      eyebrow: 'Android Closed Test',
      title: 'Vaktio+ Closed Test',
      lede: 'The app is currently in the required closed test phase for Google Play release.',
      intro: 'Follow the steps below to join the test.',
      joinHeading: 'Join the group',
      joinDescription: 'First, request access to the test group.',
      groupCta: 'Join the test group',
      groupUrl: 'https://groups.google.com/u/2/g/vaktio-testers',
      stepsHeading: 'Test steps',
      steps: [
        'Open the opt-in link below',
        'Tap the Become a tester button',
        'Download and use the app from Play Store',
      ],
      linksHeading: 'Test links',
      links: [
        {
          label: 'Android',
          href: 'https://play.google.com/store/apps/details?id=com.hasanalay.vaktioplus',
